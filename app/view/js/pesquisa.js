...
function pesquisar(e) {
  e.preventDefault();
  $("#carregarmais").removeAttr('hidden');
  ...
  var request = gapi.client.youtube.search.list({
    ...
    type: "video",
    //-------------------------------------------
    // esse q significa a query, isso é, o que vai ser pesquisado
...
function carregarmais(e) {
  ...
  if (resultados >= 50) {
    resultados = 50;
    $('#carregarmaisbutton').addClass('disabled');
    $('#carregarmaisbutton').text('Limite Atingido!');
  }
